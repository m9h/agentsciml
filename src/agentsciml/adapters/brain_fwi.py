...
FWIConfig parameters:
    ...
    grid_size: int                         # N^3 grid size (default 64-256)

Experiment structure:
    - Define run_experiment() function
    - Call it in if __name__ == "__main__"
    - Each result must call print_result() AND log_result()
    - 120-minute timeout — allow for high-fidelity 256^3 grids and deep convergence.
...
"""
    ...
    def get_constraints(self) -> str:
        return (
            "Hard constraints:\n"
            "1. Total experiment wall time < 120 minutes.\n"
            "2. Keep grid_size <= 256 and iters <= 100 to avoid timeouts.\n"
